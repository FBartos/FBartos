...
- **[PublicationBiasBenchmark](https://cran.r-project.org/package=PublicationBiasBenchmark)** - Benchmark for publication bias correction methods - An R package with unified interface for benchmarking meta-analytic
    publication bias correction methods through simulation studies (see the [benchmark](https://fbartos.github.io/PublicationBiasBenchmark/))
